...
export const marketingCopy: Record<Locale, MarketingCopy> = {
  en: {
    ...
    preview: {
      title: "Live lead desk",
      subtitle: "Website chat, WhatsApp, Instagram, and API channels in one queue.",
      signalTitle: "Qualification signals",
      nextActionLabel: "Next best action",
      nextAction: "Offer booking slot",
      threads: [
        {
          name: "Maria K.",
          channel: "Website chat",
          summary: "Asked for pricing and a consultation this week.",
          status: "Sales-ready",
          score: "92",
        },
        {
          name: "Andreas P.",
          channel: "Instagram",
          summary: "Needs service area confirmation before booking.",
        ...
        },
        {
          name: "Elena D.",
          channel: "WhatsApp",
          summary: "Shared requirements, missing contact consent.",
          status: "Review",
          score: "48",
        },
      ],
  ...
  el: {
    ...
    preview: {
      title: "Live lead desk",
      subtitle: "Website chat, WhatsApp, Instagram και API κανάλια σε μία ουρά.",
      signalTitle: "Qualification signals",
      nextActionLabel: "Επόμενη ενέργεια",
      nextAction: "Πρόταση για booking slot",
      threads: [
        {
          name: "Μαρία Κ.",
          channel: "Website chat",
          summary: "Ζήτησε τιμές και consultation μέσα στην εβδομάδα.",
          status: "Έτοιμο για πώληση",
          score: "92",
        },
        {
          name: "Ανδρέας Π.",
          channel: "Instagram",
          summary: "Χρειάζεται επιβεβαίωση περιοχής πριν το ραντεβού.",
          status: "Δρομολόγηση",
          score: "71",
        },
        {
